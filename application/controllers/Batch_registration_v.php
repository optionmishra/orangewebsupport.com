...
class Batch_registration_v extends CI_Controller
{
  ...
  function show_data()
  {
    ...
    $classes = [
      6 => $this->csvToArray('assets/V6.csv'),
      7 => $this->csvToArray('assets/V7.csv'),
      8 => $this->csvToArray('assets/V8.csv'),
    ];
  ...
  function check_register($data, $class, $sectionsArr)
  {
    ...
    foreach ($data as $row) {
      ...
      $student_data['school_name'] = "Vidyanchal";
      $student_data['address'] = ' ';
      $student_data['stu_teacher_id'] = 'jfm482kb7e';
      $student_data['city'] = ' ';
      $student_data['state'] = ' ';
