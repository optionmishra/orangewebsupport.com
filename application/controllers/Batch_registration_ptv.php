...
class Batch_registration_ptv extends CI_Controller
{

  public $upload_error;
  public $error;

  public $teacher_code = "9k708i5ldc";
  public $password = "PTVA@2024";
  public $school = "Parle Tilak Vidyalaya English High School";
  ...
  function show_data()
  {
    ...
    $classes = [
      5 => $this->csvToArray('assets/PTV5.csv'),
      6 => $this->csvToArray('assets/PTV6.csv'),
      7 => $this->csvToArray('assets/PTV7.csv'),
      8 => $this->csvToArray('assets/PTV8.csv'),
    ];
  ...
  function check_register($data, $class, $sectionsArr)
  {
    ...
    foreach ($data as $row) {
      ...
      $student_data['school_name'] = $this->school;
      $student_data['address'] = ' ';
      $student_data['stu_teacher_id'] = $this->teacher_code;
      $student_data['city'] = ' ';
      $student_data['state'] = ' ';
