...
class Batch_registration_ox extends CI_Controller
{
  ...
  function show_data()
  {
    ...
    $classes = [
      3 => $this->csvToArray('assets/OX3.csv'),
      4 => $this->csvToArray('assets/OX4.csv'),
      5 => $this->csvToArray('assets/OX5.csv'),
    ];
  ...
  function check_register($data, $class, $sectionsArr)
  {
    ...
    foreach ($data as $row) {
      ...
      $student_data['school_name'] = "OXFORD BLOCK";
      $student_data['address'] = ' ';
      $student_data['stu_teacher_id'] = $class < 5 ? '56EDM8CB23' : '04HDBK5CFM';
      $student_data['city'] = ' ';
      $student_data['state'] = ' ';
