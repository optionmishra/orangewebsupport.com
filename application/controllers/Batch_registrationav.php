...
class Batch_registrationav extends CI_Controller
{
    ...
    function show_data()
    {
        ...
        $classes = [
            5 => $this->csvToArray('assets/av5.csv'),
            6 => $this->csvToArray('assets/av6.csv'),
            7 => $this->csvToArray('assets/av7.csv'),
            8 => $this->csvToArray('assets/av8.csv'),
        ];
    ...
    function check_register($data, $class, $sectionsArr)
    {
        ...
        foreach ($data as $row) {
            ...
            $student_data['school_name'] = "Adarsh Vidyalaya Goregaon West, Mumbai";
            $student_data['address'] = 'Mumbai';
            $student_data['stu_teacher_id'] = 'BF87K04M9L';
            $student_data['city'] = ' ';
            $student_data['state'] = ' ';
