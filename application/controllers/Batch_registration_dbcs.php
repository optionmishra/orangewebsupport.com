...
class Batch_registration_dbcs extends CI_Controller
{
  ...
  function show_data()
  {
    ...
    $classes = [
      1 => $this->csvToArray('assets/DBCS1.csv'),
      2 => $this->csvToArray('assets/DBCS2.csv'),
      3 => $this->csvToArray('assets/DBCS3.csv'),
      4 => $this->csvToArray('assets/DBCS4.csv'),
      5 => $this->csvToArray('assets/DBCS5.csv'),
      6 => $this->csvToArray('assets/DBCS6.csv'),
      7 => $this->csvToArray('assets/DBCS7.csv'),
    ];
  ...
  function check_register($data, $class, $sectionsArr)
  {
    ...
    foreach ($data as $row) {
      ...
      $student_data['password'] = 'welcome123';
      $student_data['pin'] = '123456';
      $student_data['school_name'] = "Donbosco CBSE School";
      $student_data['address'] = ' ';
      $student_data['stu_teacher_id'] = $class < 5 ? '21B5GIHD3k' : 'F1LBIHJKM6';
      $student_data['city'] = ' ';
      $student_data['state'] = ' ';
