...
class Batch_registration_spsis extends CI_Controller
{
  ...
  function show_data()
  {
    ...
    $classes = [
      5 => $this->csvToArray('assets/spsis5.csv'),
      6 => $this->csvToArray('assets/spsis6.csv'),
      7 => $this->csvToArray('assets/spsis7.csv'),
      8 => $this->csvToArray('assets/spsis8.csv'),
    ];
  ...
  function check_register($data, $class, $sectionsArr)
  {
    ...
    foreach ($data as $row) {
      ...
      $student_data['school_name'] = "Satguru Partap Singh International School";
      $student_data['address'] = ' ';
      $student_data['stu_teacher_id'] = 'A4GDIH68L7';
      $student_data['city'] = ' ';
      $student_data['state'] = ' ';
