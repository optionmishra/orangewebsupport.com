...
class Batch_registration_jbl extends CI_Controller
{
  ...
  function show_data()
  {
    ...
    $classes = [
      3 => $this->csvToArray('assets/JBL3.csv'),
      4 => $this->csvToArray('assets/JBL4.csv'),
      5 => $this->csvToArray('assets/JBL5.csv'),
      6 => $this->csvToArray('assets/JBL6.csv'),
      7 => $this->csvToArray('assets/JBL7.csv'),
      8 => $this->csvToArray('assets/JBL8.csv'),
    ];
  ...
  function check_register($data, $class, $sectionsArr)
  {
    ...
    foreach ($data as $row) {
      $student_data['name'] = $row['FIRST'] . ' ' . $row['LAST'];
      $student_data['mobile'] = '';
      $student_data['email'] = $row['EMAIL'];
      $student_data['password'] = 'stemrobo';
      $student_data['pin'] = '123456';
      $student_data['school_name'] = "JB Ludhani High School";
      $student_data['address'] = ' ';
      $student_data['stu_teacher_id'] = 'm4587f96k1';
      $student_data['city'] = ' ';
      $student_data['state'] = ' ';
