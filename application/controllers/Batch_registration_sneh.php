...
class Batch_registration_sneh extends CI_Controller
{
  ...
  function show_data()
  {
    ...
    $classes = [
      6 => $this->csvToArray('assets/SNEH6.csv'),
      7 => $this->csvToArray('assets/SNEH7.csv'),
      8 => $this->csvToArray('assets/SNEH8.csv'),
      9 => $this->csvToArray('assets/SNEH9.csv'),
      10 => $this->csvToArray('assets/SNEH10.csv'),
    ];
  ...
  function check_register($data, $class, $sectionsArr)
  {
    ...
    foreach ($data as $row) {
      ...
      $student_data['school_name'] = "SNEH International School";
      $student_data['address'] = ' ';
      $student_data['stu_teacher_id'] = '5b24am09kg10';
      $student_data['city'] = ' ';
      $student_data['state'] = ' ';
