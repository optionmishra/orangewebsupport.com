...
class Batch_registration_aps extends CI_Controller
{

  public $upload_error;
  public $error;

  public $teacher_code = "f38im9l14b";
  public $password = "APS@2024";
  public $school = "Army Public School";
  ...
  function show_data()
  {
    ...
    $classes = [
      5 => $this->csvToArray('assets/APS5.csv'),
      // 6 => $this->csvToArray('assets/PTV6.csv'),
      // 7 => $this->csvToArray('assets/PTV7.csv'),
      8 => $this->csvToArray('assets/APS8.csv'),
    ];
