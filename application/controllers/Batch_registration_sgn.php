...
class Batch_registration_sgn extends CI_Controller
{
  ...
  function show_data()
  {
    ...
    $classes = [
      6 => $this->csvToArray('assets/sgn6.csv'),
      7 => $this->csvToArray('assets/sgn7.csv'),
      8 => $this->csvToArray('assets/sgn8.csv'),
    ];
  ...
  function check_register($data, $class, $sectionsArr)
  {
    ...
    foreach ($data as $row) {
      ...
      $student_data['school_name'] = "SHANTI GYAN NIKETAN";
      $student_data['address'] = ' ';
      $student_data['stu_teacher_id'] = '5DJ28E93IC';
      $student_data['city'] = ' ';
      $student_data['state'] = ' ';
