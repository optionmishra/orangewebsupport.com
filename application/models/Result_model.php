...
class Result_model extends CI_Model
{
  ...
  /**
   * Get student submissions grouped by paper mode
   */
   ...
   */
  public function get_student_result($class, $section, $student_code)
  {
    $this->db->where('class', $class);
    $this->db->where('section', $section);
    $this->db->where('stu_teacher_code', $student_code);
