...
<aside class="app-sidebar">
	...
	<ul class="app-menu">
		...
		<li><a class="app-menu__item" href="superadmin/web_users" target="_blank"><i class="fa fa-list app-menu__icon" aria-hidden="true"></i> <span class="app-menu__label"> Users Management</span></a>
	</ul>
</aside>