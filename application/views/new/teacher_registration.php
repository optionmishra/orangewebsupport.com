				...
				<div class="form-body">
					...
					<div id="seriesClassesContainer" class="row m-0 p-2">
						<div class="col-lg-12 p-2">
							<select class="form-control series-select" name="series[]" id="series" required>
								<option value="" disabled selected>Select Series (Please select your board first)</option>
							</select>
						</div>
					</div>
					<buttton id="addSeries" class="btn btn-sm btn-outline float-right">+ Add More Series</buttton>
				</div>
