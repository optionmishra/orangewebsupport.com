...
$(".supportTables").on("click", ".delete_support", function () {
	...
	const file1 = $(this).attr("file1");
	const file2 = $(this).attr("file2");
	swal({
		title: "Are you sure?",
		text: "You won't be able to revert this!",
		type: "warning",
...
$("#mystudentrecord").click(function () {
	$("#stexamrecord").hide();
	$("#hide_student_tbl").show();
});
