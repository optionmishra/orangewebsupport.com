    ...
    <div class="modal fade" id="madd-new-subject" tabindex="-1" role="dialog" aria-labelledby="madd-new-subject" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="maddSubject" class="smooth-submit" method="post" action="<?= base_url('admin_master/madd_subject') ?>"
                      <div class="form-body">
        ...
        <div class="modal fade" id="medit-subject" tabindex="-1" role="dialog" aria-labelledby="medit-subject" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form id="mupdate-subject" class="smooth-submit" method="post" action="<?= base_url('admin_master/mupdate_subject') ?>"
                          <div class="form-body">
                            <div class="row m-0 p-2">
                                <div class="col-lg-6 p-2">
                                    <div class="form-group">
