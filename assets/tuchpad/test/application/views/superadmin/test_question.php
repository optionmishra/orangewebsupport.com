                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <select class="form-control" name="set" id="queSet" required>
                                    ...
                                    <option value="11">cdhdhgf</option>
                                    <option value="12">ch 2</option>
                                    <option value="13">ch 3</option>
                                    <option value="14">ch 4</option>
                                    <option value="21">ch 5</option>
                                    <option value="22">ch 6</option>
                                </select>
                                </select>
                            </div>
                        </div>
